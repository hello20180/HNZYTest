		...
		<link rel="stylesheet" type="text/css"
			...
			function yzpwd(){
			    ...
			    if(pwd!=pwdnew){
			   	 ...
			   	 $("#pw").append("<div><font color='#FF4500'>您输入的新密码与确认密码确认不一致</font></div>");
			    	  document.getElementById('pwdnew').innerHTML ="";
	...
	<body>
		<div class="page-container">
			<form class="form form-horizontal" id="form-user-pwd"
				action="loginCon/updapwd.action" method="post">
				<input type="hidden" name="id" id="id" value="${changepwd.id}" />
				<input type="hidden"  name="oldpwd" id="oldpwd" value="${changepwd.pwd}" />
				...
				<div class="row cl">
					...
					<div style="float: left;" class="formControls col-5">
						<input  class="input-text" id="passOld"
							name="passOld"  readonly="true" required value="${changepwd.pwd}">
					</div>
				...
				<div class="row cl">
					...
					<div style="float: left;" class="formControls col-5">
						<input type="password" class="input-text" id="pwdnew"
							name="pwdnew" required>
					</div>
					<div id="pw"></div>
				</div>
				<div class="row cl">
					<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
						<input class="btn btn-primary radius" type="button" onclick="yzpwd()"
							value="&nbsp;&nbsp;修&nbsp;改&nbsp;&nbsp;">
					</div>
				</div>
			</form>
