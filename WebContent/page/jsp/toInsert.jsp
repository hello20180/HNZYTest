...
<body>
	<div class="page-container">
		<form class="form form-horizontal" id="form-user-pwd"
			action="myInfoCon/Insert.action" >
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"> <span
					class="c-red">*</span>姓名:
				</label>
				<div style="float: left;" class="formControls col-5">
					<input required autofocus type="text" class="input-text" name="name" id="nameId">
				</div>
			</div>
					<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"> <span
				...
				<div style="float: left;" class="formControls col-5">
					<input type="text" class="input-text" id="ageId" name="age" required>
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div style="float: left;" class="formControls col-5">
					<input type="text" class="input-text" id="schoolId" name="school" required>
				</div>
			</div>
				<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"> <span
				...
				<div style="float: left;" class="formControls col-5">
					<input type="text" class="input-text" id="addressId" name="address" required>
				</div>
			</div>
			<div class="row cl">
